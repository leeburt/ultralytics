#!/usr/bin/env python3
"""
在训练集上搜索最优阈值组合（conf, nms_radius, match_distance）。
"""
import cv2
import numpy as np
import torch
...
OUTPUT_ROOT = Path("/data-ssd/libo/p100/yolo_utils/dataset/external_inline/train_threshold_sweep")
NUM_SAMPLES = 200
SEED = 42
...
def main():
    ...
    pbar = tqdm(total=total_combos, desc="阈值搜索")
